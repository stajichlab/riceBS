GENOME_input=$1  ## directory that contains the genome FASTA(S)
FQ1_input=$2     ## just the file name, scripts looks in $CWD/reads for the file
FQ2_input=$3
BASE_input=$4    ## the common samplename in the 2 FASTQ filenames ex: BASE=NB_1 FQ1=NB_1.p1.fq FQ_2=NB_1.p2.fq
PWD=`pwd`
echo "
#PBS -q highmem
...
#### Varibles populated by standard in ########
CWD=$PWD
